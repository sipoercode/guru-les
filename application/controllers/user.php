...
class User extends BaseController
{
    ...
    {
        $this->global['pageTitle'] = 'Guru Les : Dashboard';
    ...
    function userListing()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Guru Les : User Listing';
    ...
    function addNew()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Guru Les : Add New User';
        ...
        else
        {
            ...
            else
            {
                ...
                $userInfo = array('email'=>$email, 
                                  'password'=>getHashedPassword($password), 'roleId'=>$roleId, 
                                  'name'=> $name,
    ...
    {
        $this->global['pageTitle'] = 'Guru Les : Change Password';
